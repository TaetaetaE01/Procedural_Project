...
public class UMyInfo extends JFrame {

	public void umyinfo(VPersonalInfo vPersonalInfo) {
		...
		pwcheckbtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				UPwconfirm uPwconfirm = new UPwconfirm();
				uPwconfirm.pwconfirm(vPersonalInfo);
				uPwconfirm.setVisible(true);
